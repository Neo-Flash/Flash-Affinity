...
dataset = Ligand_Protein_Dataset("./dataset", config.data_dir, config.affinity_file, config.dataset_fraction)
...
print("Saving...")
torch.save(best_model, "./checkpoint/best_model.pt")
torch.save(trained_model, "./checkpoint/model.pt")
torch.save(optimizer, "./checkpoint/optimizer.pt")
if config.use_scheduler:
    torch.save(scheduler, "./checkpoint/scheduler.pt")